  ...
  return (
    <>
      <Head>
        ...
        <link href={`/static/css/min/article.css?v=${process.env.NEXT_APP_GIT_SHA1}`} rel="stylesheet" fetchpriority="high" />
        ...
        <link rel="stylesheet" href={`/static/css/min/code.css?v=${process.env.NEXT_APP_GIT_SHA1}`} fetchpriority="high" />
