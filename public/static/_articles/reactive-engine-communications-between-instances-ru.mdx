...
author: "Den Pol"
tags: ["react", "reactivity", "reactive_engine", "performance", "производительность", "реактивность", "реактивное_программирование", "javascript"]
category: "news"
isPrivate: false
---
> Эта статья про развитие движка **[ReactiveEngine](https://www.npmjs.com/package/@pravosleva/reactive-engine)** в ходе которого рассматриваются фундаментальные вещи во Frontend разработке.
...
![Rhubarbes lab (fb group)](/static/img/blog/FB_IMG_1788818469987.webp "404 City")
...
<ControlsBox
  controlsJson='[
    ...
    {
      "title": "NEXT",
      "label": "React vs Vue 3: Прямое сравнение",
      "type": "link",
      "link": "/p/react-vs-vue3"
    }
  ]'
/>
