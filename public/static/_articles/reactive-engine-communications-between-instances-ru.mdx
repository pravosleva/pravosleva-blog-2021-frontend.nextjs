...
isPrivate: false
---
> Эта статья про развитие движка **[ReactiveEngine](https://www.npmjs.com/package/@pravosleva/reactive-engine)** в рамках которого рассматриваются фундаментальные вещи во Frontend разработке.
