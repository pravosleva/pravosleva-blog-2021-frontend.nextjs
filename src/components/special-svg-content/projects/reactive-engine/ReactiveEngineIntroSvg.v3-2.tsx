...
export const ReactiveEngineIntroSvg = () => {
  ...
  return (
    ...
    >
      {/* 📐 ШИРОКОФОРМАТНЫЙ ВЕКТОРНЫЙ СЛОЙ С ТЕКСТОВЫМ АРТОМ И ВПИСАННЫМ РЕАКТИВНЫМ ДВИГАТЕЛЕМ */}
      <svg
      ...
      >
          ...
          <style>
            {`
              ...
              @media (max-width: 420px) {
                .reactive-engine-logo-svg {
                  /* !important принудительно выжигает инлайновые width/margin/transform на мобилках */
        ...
        {/* 🎯 СИСТЕМА СТАТИЧНЫХ ГЛОБАЛЬНЫХ ФОНОВЫХ КОЛЕЦ (Центрированы по оси 400, 175) */}
        {/* Фикс: Пульсация и лишняя анимация полностью удалены для сохранения строгого минимализма */}
        <circle cx="400" cy="175" r="35" fill="none" stroke={primaryColor} strokeWidth="1.5" opacity="0.2" />
        <circle cx="400" cy="175" r="85" fill="none" stroke={primaryColor} strokeWidth="1.5" opacity="0.1" />
        <circle cx="400" cy="175" r="145" fill="none" stroke={primaryColor} strokeWidth="1" opacity="0.04" />
        
        {/* Внешнее акцентное кольцо-нимб вокруг сопла */}
        <circle cx="400" cy="175" r="64" fill="none" stroke={neonOrange} strokeWidth="1.2" opacity="0.25" strokeDasharray="3, 3" />

        {/* 🔤 СЛОВО "Reactive" (Слева, выровнено по правому краю x=335) */}
        <text 
          x="335" 
          y="215" 
        ...
        {/* 🔤 СЛОВО "Engine" (Справа, горит неоном, выровнено по левому краю x=465) */}
        <text 
          x="465" 
          y="215" 
          fontFamily="Montserrat, system-ui, -apple-system, sans-serif" 
        ...
        <g id="reactive-engine-core" filter="url(#text-art-shadow)">
          <circle cx="400" cy="175" r="62" fill={subColor} stroke={primaryColor} strokeWidth="0" />
          <g transform="translate(400, 175) scale(0.2) rotate(270) translate(-262, -256)">
            <path 
