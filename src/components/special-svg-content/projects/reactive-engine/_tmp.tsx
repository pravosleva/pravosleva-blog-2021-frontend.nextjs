...
export const ReactiveEngineIntroSvg = React.memo(() => {
  const neonOrange = '#FF8E53'; // Фирменный оранжевый неон для слова "Engine"
  ...
  return (
    ...
    >
      ...
      <svg
        className='reactive-engine-logo-svg'
        viewBox="0 0 800 150" 
        width="100%" 
        height="auto" 
      ...
      >
        <defs>
          {/* Мягкая тень для объемного эффекта букв и металла */}
        ...
        {/* 🎯 СИСТЕМА СТАТИЧНЫХ ГЛОБАЛЬНЫХ ФОНОВЫХ КОЛЕЦ: Перенесены на ось Y = 75 */}
        {/* <circle cx="400" cy="75" r="35" fill="none" stroke={primaryColor} strokeWidth="1.5" opacity="0.2" />
        <circle cx="400" cy="75" r="85" fill="none" stroke={primaryColor} strokeWidth="1.5" opacity="0.1" />
        <circle cx="400" cy="75" r="145" fill="none" stroke={primaryColor} strokeWidth="1" opacity="0.04" /> */}
        ...
        {/* Внешнее акцентное кольцо-нимб вокруг сопла */}
        {/* <circle cx="400" cy="75" r="64" fill="none" stroke={neonOrange} strokeWidth="1.2" opacity="0.25" strokeDasharray="3, 3" /> */}

        {/* 🔤 СЛОВО "Reactive" (Базовая линия Y скорректирована до 112) */}
        <text 
          x="335" 
          y="112" 
        ...
        {/* 🔤 СЛОВО "Engine" (Базовая линия Y скорректирована до 112) */}
        <text 
          x="465" 
          y="112" 
          fontFamily="Montserrat, system-ui, -apple-system, sans-serif" 
