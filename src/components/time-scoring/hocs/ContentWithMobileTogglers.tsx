...
export const ContentWithMobileTogglers = (props: TProps) => (
  <Container>
    ...
    >
      {
        ...
        ? <BarChartIcon fontSize='medium' /> // <i className="fa fa-chart-bar" style={{ fontSize: "20px" }} />
        : <InfoIcon fontSize='medium' /> // <i className="fas fa-info" style={{ fontSize: "18px" }} />
      }
    </ListMobileToggler>
    ...
    >
      {
        !!props.activeEmployee
        ? <FilterAltIcon fontSize='medium' /> // <i className="fas fa-filter" style={{ fontSize: "16px" }}></i>
        : <MoreVertIcon fontSize='medium' /> // <i className="fas fa-ellipsis-v" style={{ fontSize: "20px" }} />
      }
    </SidebarMobileToggler>
