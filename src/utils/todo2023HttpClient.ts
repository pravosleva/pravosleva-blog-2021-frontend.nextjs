...
const baseApiURL = isDev ? 'http://pravosleva.ru/express-helper/subprojects/gapi/todo-2023' // 'http://localhost:5000/subprojects/gapi/todo-2023'
...
class httpClientSingletone {
  ...
  async getJobs() {
    ...
    const result: TLocalResult = await this.api('/jobs', opts)
